...
//necessário que retorne esses caracteres: VD, VM, AM

//http://url-da-api/endpoint

//declarar os três pinos
const int VD = 22;
const int VM = 19;
const int AM = 18;
const int BZ = 5;
...
void setup() {
  ...
  //inicializar como saída os três pinos
...
void loop() {
  ...
  delay(20000); // espera para não ficar a todo momento requisitando no servidor/endpoint
}
